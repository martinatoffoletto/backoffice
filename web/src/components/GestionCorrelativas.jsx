          ...
          <form onSubmit={handleSubmit} className="space-y-5 w-full">
            ...
            {materiaOrigen && (
              <>
                <div className="mb-4">
                  <p>
                    <strong>Materia encontrada:</strong> {materiaOrigen.nombre}{" "}
                    (ID: {materiaOrigen.id_materia})
                  </p>
                </div>
                ...
                <Field>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        {selectedValues.length > 0
                          ? allMaterias
                              .filter((m) =>
                                selectedValues.includes(m.id_materia)
                              )
                              .map((m) => m.nombre)
                              .join(", ")
                    ...
                    <PopoverContent className="w-[250px] p-2">
                      {allMaterias
                        .filter(
                          (m) => m.id_materia !== materiaOrigen.id_materia
                        )
                        .map((m) => (
                          <div
                            key={m.id_materia}
                          ...
                          >
                            <Checkbox
                              checked={selectedValues.includes(m.id_materia)}
                            />
