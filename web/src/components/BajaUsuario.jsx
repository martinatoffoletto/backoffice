  ...
  return (
    <div className="flex flex-col w-full min-h-screen items-start justify-start mt-6 py-4 sm:px-8">
      <div className="w-full max-w-4xl">
        ...
        {found && user && (
          <div className="w-full bg-white border-2 border-red-500 p-6 rounded-xl shadow-lg mt-6">
        ...
        {deleted && (
          <div className="w-full bg-white border-2 border-green-500 p-6 rounded-xl shadow-lg mt-6">
